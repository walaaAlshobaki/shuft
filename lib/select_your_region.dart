      ...
      body: Container(
       child: Stack(
         ...
         Padding(
          ...
          child: Text('Select your region',
            style: TextStyle(
              fontSize: 35.0,
               ...
               Center(child: Image.asset("assets/img/g3.png",width: 277,height: 195,) ,),
               Padding(
          ...
          child:  roundedRectButton("Next",Colors.white, blueGradients, LetsStarting()),
                 
              ),
               Padding(
          padding: EdgeInsets.fromLTRB(20, 750,0, 0),
          child:  roundedRectButton("Back",Color(0xff55CE9D), whiteGradients, YourLessonsWhenYouWant()),
