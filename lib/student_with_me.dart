...
class StudentWithMeClass extends StatefulWidget {
  @override
  _StudentWithMeClassState createState() => _StudentWithMeClassState();
}

class _StudentWithMeClassState extends State<StudentWithMeClass> {
