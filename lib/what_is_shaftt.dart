      ...
      body: Container(
       child: Stack(
         ...
         Padding(
          ...
          Center(child: Image.asset("assets/img/g1.png",width: 277,height: 195,) ,),
              
               Padding(
          padding: EdgeInsets.fromLTRB(20, 620,10, 0),
          child: Text('Classic way to get your license fast And save.',
            style: TextStyle(
              ...
              Padding(
          padding: EdgeInsets.fromLTRB(300, 750,20, 0),
          child:  roundedRectButton("Next",Colors.white, blueGradients, YourLessonsWhenYouWant()),
