...
String errMessage = 'Error Uploading Image';
 ...
 setState(() {
  ...
  var url = 'http://sheft-platform.com/API/register.php';
   if(isSelected[0]){
    gende="male";
  }else{
    gende="female";
  ...
  print('fileName'+fileName+'id'+id+'gender'+gende);

  var data = {'role':"studant",'firstName':firstname,'lastName':lastname,'email': email,'password': password,'phoneNumber':phone,'birthday':selectedDate.toIso8601String(),'image':base64Image,'fileName':fileName,'id':id,'gender':gende};
              ...
              height: 70 ,
                     child:Card(
                            ...
                            borderRadius: BorderRadius.circular(20),
                                ...
                                elevation: 0,
                                child: Text('set',style: TextStyle(fontSize: 22,fontFamily: "HelveticaBold"),),color: Colors.white,textColor:  Color(0xff55CE9D),
                              ),
                                ],
                                ),
                                )
            ...
            onPressed: _choose,
                            ...
                            child: Container(
                                  ...
                                  child:Container(
                                    height:60,
                                    width: 340,
                                    child: roundedRectButton("Signup",Color(0xffffffff), blueGradients,StudantMainLogin()),
                                      )  
                                      ),
                ],
              ),
